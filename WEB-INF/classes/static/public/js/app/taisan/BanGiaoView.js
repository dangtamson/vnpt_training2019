var BanGiaoView = function(){
	
	var that = this;
	this.AppTitle = 'Bàn giao tài sản';
	this.oTable = null;
	this.oDialog = null;
	...
	$(document).ready(function () {
		...
		$('.ACTIONS').on('click', '#btnThemMoi', function () {
			that.oDialog.show('Lập biên bản bàn giao tài sản', CONFIG_APP.URL.CONTEXT + '/app/taisan/bangiaoct', '80%', '650');
		});
